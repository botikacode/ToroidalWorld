//Code for Controls/StatsLabel (Container)
...
partial class StatsLabel : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/StatsLabel");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Controls/StatsLabel - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new StatsLabel(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(StatsLabel)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/StatsLabel", () => 
        {
    ...
    public StatsLabel(InteractiveGue visual) : base(visual)
    {
    }
    public StatsLabel()
    {
