//Code for Controls/SliderCustom (Container)
...
partial class SliderCustom : global::Gum.Forms.Controls.Slider
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/SliderCustom");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Controls/SliderCustom - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new SliderCustom(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(SliderCustom)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/SliderCustom", () => 
        {
    ...
    public SliderCustom(InteractiveGue visual) : base(visual)
    {
    }
    public SliderCustom()
    {
