//Code for Elements/PercentBarXP (Container)
...
partial class PercentBarXP : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Elements/PercentBarXP");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Elements/PercentBarXP - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new PercentBarXP(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(PercentBarXP)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Elements/PercentBarXP", () => 
        {
    ...
    public PercentBarXP(InteractiveGue visual) : base(visual)
    {
    }
    public PercentBarXP()
    {
