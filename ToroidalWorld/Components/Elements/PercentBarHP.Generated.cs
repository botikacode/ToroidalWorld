//Code for Elements/PercentBarHP (Container)
...
partial class PercentBarHP : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Elements/PercentBarHP");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Elements/PercentBarHP - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new PercentBarHP(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(PercentBarHP)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Elements/PercentBarHP", () => 
        {
    ...
    public PercentBarHP(InteractiveGue visual) : base(visual)
    {
    }
    public PercentBarHP()
    {
