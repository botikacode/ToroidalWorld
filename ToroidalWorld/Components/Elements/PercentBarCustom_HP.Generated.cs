//Code for Elements/PercentBarCustom_HP (Container)
...
partial class PercentBarCustom_HP : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Elements/PercentBarCustom_HP");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Elements/PercentBarCustom_HP - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new PercentBarCustom_HP(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(PercentBarCustom_HP)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Elements/PercentBarCustom_HP", () => 
        {
    ...
    public PercentBarCustom_HP(InteractiveGue visual) : base(visual)
    {
    }
    public PercentBarCustom_HP()
    {
